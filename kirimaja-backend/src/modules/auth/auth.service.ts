...
export class AuthService {
    ...
    async login(request: AuthLoginDto): Promise<AuthLoginResponse> {
        ...
        const accessToken = this.jwtService.sign(payload, {
            secret: process.env.JWT_SECRET_KEY || 'secretKey', // Use your secret key from environment variables
            expiresIn: process.env.JWT_EXPIRES_IN || '1h' // Set the token expiration time
        });
